# Formatting configuration for locale so_ET
...
abbrMonths=['Kob', 'Lab', 'Sad', 'Afr', 'Sha', 'Lix', 'Tod', 'Sid', 'Sag', 'Tob', 'KIT', 'LIT']

days=['Isniin', 'Salaaso', 'Arbaco', 'Khamiis', 'Jimco', 'Sabti', 'Axad']

abbrDays=['Isn', 'Sal', 'Arb', 'Kha', 'Jim', 'Sab', 'Axa']
